  ...
  <n-config-provider :theme="naiveUITheme" abstract>
    ...
    >
      ...
      <div flex-items-center p1 bg-base>
        <n-button
          class="hetero-editor__float-menu-item paragraph"
          quaternary
          m="r0.5"
          p1
          @click="runToggleHeading(0)"
        >
          <template #icon>
        ...
        <n-button
          class="hetero-editor__float-menu-item heading-1"
          quaternary
          m="r0.5"
          p1
          @click="runToggleHeading(1)"
        >
          <template #icon>
        ...
        <n-button
          class="hetero-editor__float-menu-item heading-2"
          quaternary
          m="r0.5"
          p1
          @click="runToggleHeading(2)"
        >
          <template #icon>
        ...
        <n-button
          class="hetero-editor__float-menu-item heading-3"
          quaternary
          m="r0.5"
          p1
          @click="runToggleHeading(3)"
        >
          <template #icon>
        ...
        <n-button
          class="hetero-editor__float-menu-item heading-4"
          quaternary
          m="r0.5"
          p1
          @click="runToggleHeading(4)"
        >
          <template #icon>
        ...
        <n-button
          class="hetero-editor__float-menu-item heading-5"
          quaternary
          m="r0.5"
          p1
          @click="runToggleHeading(5)"
        >
          <template #icon>
